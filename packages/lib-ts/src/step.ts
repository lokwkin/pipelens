...
export class Step {
   ...
   */
  public _executionGraphQuickchart(): string {
   ...
   */
  public async ganttQuickchart(args?: StepGanttArg): Promise<Buffer> {
   ...
   * Generate a Gantt chart via QuickChart.io, returning a PNG buffer generated by quickchart.
   */
  public static async ganttQuickChart(steps: StepMeta[], args?: StepGanttArg): Promise<Buffer> {
